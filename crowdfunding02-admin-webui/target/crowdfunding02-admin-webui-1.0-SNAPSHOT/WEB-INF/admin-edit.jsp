            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="admin/do/update.html" method="post" role="form">
                        ...
                        <button type="submit" class="btn btn-success"><i class="glyphicon glyphicon-plus">修改</i>
                        </button>
                        <button type="reset" class="btn btn-danger"><i class="glyphicon glyphicon-refresh">重置</i>
                        </button>
                    </form>
                </div>
            </div>
