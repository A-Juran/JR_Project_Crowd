...
public abstract class AbstractAuthorizeTag {
    ...
    private SecurityExpressionHandler<FilterInvocation> getExpressionHandler() throws IOException {
        ...
        //拼接SpringMvc在ServletContext域中的属性名
        String spring = FrameworkServlet.SERVLET_CONTEXT_PREFIX  + "springDispatcherServlet";

        //从ServletContext域中拿到spring容器
        ApplicationContext appContext = (ApplicationContext) servletContext.getAttribute(spring);
